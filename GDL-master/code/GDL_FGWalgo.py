...
class FGW_Unsupervised_DictionaryLearning():
    ...
    def __init__(self,
        ...
        """
        assert dataset_name in ['mutag','enzymes', 'ptc','bzr','cox2','protein','mcf7h','dhfr','triangles']
        self.dataset_name= dataset_name
        self.mode = mode
        
        str_to_method = {'ADJ': 'adjacency', 'SP':'shortest_path','LAP':'laplacian'}
        if dataset_name in ['mutag','ptc','mcf7h']:
            X,self.y=dataloader.load_local_data(data_path,dataset_name, one_hot=True)
        elif dataset_name in [ 'enzymes','protein','cox2','bzr','dhfr']:
            X,self.y=dataloader.load_local_data(data_path,dataset_name, one_hot=True)
        print('working::::::::::::::::::::::::::::::::::::')    
