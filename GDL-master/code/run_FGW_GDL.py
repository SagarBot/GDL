...
if __name__ == '__main__':
    ...
    parser.add_argument('-ds','--dataset_name', type=str,help='the name of the dataset',choices=['mutag','ptc','bzr','cox2','enzymes','protein','mcf7h','dhfr','triangles'],required=True)
    ...
    parser.add_argument('-init','--init_mode_atoms', type=int,default=0,help='initialization mode for atoms. 0 = random / 1 = sampling')
            ...
            for alpha in list_alpha:
                for seed in list_seed:
                    for l2_reg in list_l2reg:
                        ...
                        if args.dataset_name in ['mutag','ptc','bzr','cox2','protein','mcf7h','dhfr']:
                            n_clusters=2
